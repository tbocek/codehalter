...
func (a *agent) systemPrompt(sid string) (string, error) {
	...
	if skills := loadSkills(sess.Cwd, a.skillVariant(), a.deferredSkillSkip(sess)); skills != "" {
