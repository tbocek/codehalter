...
4. For each finding, name the spec item ids it belongs to, copied from the list below, never from memory. Prefer the flow or screen item over the parameter it uses.
