...
| --- | --- | --- | --- | --- |
| **codehalter** | llama.cpp router mode probed per model id, slot semaphores, prefix-rewind detector | ACP, and nothing else | Reactive on the server's 400, one structured note per completed turn | Refuses to run outside a container |
