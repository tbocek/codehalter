...
- **Project onboarding**: detects your stack and task runners, seeds per-language skills, and bootstraps empty repositories. When a tool is missing, it offers a one-click **"fix it?" card** rather than just failing.
